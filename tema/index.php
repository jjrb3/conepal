    ...
    <div class="searchbar">
      <div class="row">
       ...
       <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
          ...
          Busca nuestras propiedades de la forma mas facil.</p>
          
          <center><button class="btn btn-info"   data-toggle="modal" data-target="#loginpop">Login</button> </center>      
        </div>
          ...
          <div class="row">
            <div class="col-lg-3 col-sm-3 ">
              ...
              <option>Categoria</option>
                <option>Compradas</option>
                <option>Alquiladas</option>
                <option>En Ventas</option>
              </select>
            </div>
